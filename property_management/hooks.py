...
app_publisher = "Tamer Mohammed"
app_description = "A module to manage properties, leases, tenants and payments"
app_email = "kalila.tamer@gmail.com"
app_license = "mit"
...
doc_events = {
    "Payment Entry": {
        "validate": "property_management.overrides.payment_entry.validate"
    }
}